...
<nav >
    <div class="nav-wrapper white"  style="box-shadow: 1px 1px 1px blue; padding-left: 300px;">
        ...
        <ul class="sidenav sidenav-fixed" style="width: 220px;">
            ...
            <li style="padding-top: 30px;"><a href="consulta.php" align="center"><i class="material-icons">account_circle</i>Alumno</a></li>
            <li><div class="divider"></div></li>
            <li style="padding-top: 30px;"><a href="carga.php" align="center"><i class="material-icons">cloud</i>Bases</a></li>
            <li><div class="divider"></div></li>
        ...
        <ul class="side-nav" id="mobile-demo">
                ...
                <li><a href="consulta.php">Menu consulta</a></li>
                <li><a href="carga.php">Menu de carga</a></li>
                <li><a>Registro</a></li>
            </ul>
        <?php } ?>
    </div>
